...
local ToggleAimBotSkill = Tabs.Player:AddToggle("ToggleAimBotSkill", {Title = "Auto Aimbot Skill",Description = "Tự Động ngắm Skill", Default = true })
...
Window:SelectTab(1)
Fluent:Notify({
    Title = "Lmao Hub skidder in Fai fao hub",
    Content = "The script has been refunded.",
    Duration = 8
})
